...
class UHGBaseOptimizer(Optimizer):
    ...
    def _check_manifold_constraint(
        self, param: torch.Tensor, group: Dict[str, Any]
    ) -> bool:
        """
    ...
    def _compute_hyperbolic_gradient(
    ...
    def _update_hyperbolic_step(
        self, param: torch.Tensor, hgrad: torch.Tensor, group: Dict[str, Any]
    ) -> torch.Tensor:
        """
    ...
    def _project_to_tangent_space(
        self, vector: torch.Tensor, point: torch.Tensor, group: dict
    ) -> torch.Tensor:
        """
    ...
    def _exponential_map(
        self, point: torch.Tensor, tangent_vector: torch.Tensor
    ) -> torch.Tensor:
        """
