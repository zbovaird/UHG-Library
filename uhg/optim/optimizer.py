...
class ProjectiveOptimizer(Optimizer):
    ...
    def __init__(self, params: List[torch.Tensor], defaults: Dict[str, Any]):
    ...
    def update_parameter(
        self, p: torch.Tensor, d_p: torch.Tensor, lr: float
    ) -> torch.Tensor:
    ...
    def preserve_cross_ratio(
        self, group: Dict[str, Any], state: Dict[str, Any], p: torch.Tensor
    ) -> None:
