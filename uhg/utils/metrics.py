...
def evaluate_cross_ratio_preservation(
    model: torch.nn.Module, data: torch.Tensor, num_samples: int = 10
) -> float:
    ...
    with torch.no_grad():
        ...
        for _ in range(num_samples):
            ...
            if check_cross_ratio(out[idx[0]], out[idx[1]], out[idx[2]], out[idx[3]]):
                preserved += 1
