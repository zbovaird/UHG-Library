...
class ProjectiveGraphSAGE(nn.Module):
    ...
    def __init__(
        ...
        self.layers.append(
            ProjectiveSAGEConv(
                in_features=in_channels, out_features=hidden_channels, bias=bias
            )
        )
        ...
        for _ in range(num_layers - 2):
            self.layers.append(
                ProjectiveSAGEConv(
                    in_features=hidden_channels, out_features=hidden_channels, bias=bias
                )
            )
        ...
        self.layers.append(
            ProjectiveSAGEConv(
                in_features=hidden_channels, out_features=out_channels, bias=bias
            )
        )
